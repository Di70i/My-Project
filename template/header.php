...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="<?php $config['app_url'] ?>index.php"> <?php echo $config['app_name']?></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="<?php $config['app_url']?>store.php">تسوق<span class="sr-only">(current)</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php $config['app_url']?>contact.php">تواصل معنا</a>
            </li>
        </ul>
