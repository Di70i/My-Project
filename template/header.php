...
<nav class="navbar navbar-expand-lg navbar navbar-light bg-light">
    <i class="fas fa-store-alt" style='font-size:48px;color:wheat'></i><a class="navbar-brand" href="<?php echo $config['app_url'] ?>index.php"><span><?php echo $config['app_name']?></<span></a></i>
